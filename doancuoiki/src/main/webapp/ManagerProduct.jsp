...
<head>
    ...
    <title>Quản Lí Sản Phẩm Page</title>
    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="sendirectpage"  class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Thêm Sản Phẩm</span></a>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="form-select" aria-label="Default select example">
                            <c:forEach items="${listCC}" var="o">
                                <option value="${o.cid}">${o.name}</option> // mình cho người dùng xem cái name
                                // còn get là mình get cái id về
                                // vd như cái thẻ select này mình get là get cái byname còn lấy dữ liệu là mình lấy cái value này
                            </c:forEach>
                        </select>
                    </div>
